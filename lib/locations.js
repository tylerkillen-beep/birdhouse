...
const NHS_LOCATIONS = [
  ...
  { label: 'Bennett, Cristy — Homebound',             value: '176'      },
  { label: 'Blansit, Brock — PE',                     value: 'Gym/184'  },
  { label: 'Blansit, Danelle — Athletics/Activities', value: '276'      },
  { label: 'Boyce, Andrew — PE',                      value: 'Gym/184'  },
  { label: 'Boyd, Kacey — Science',                   value: '265'      },
  { label: 'Bradford, Michael — Band',                value: 'Band Rm'  },
  { label: 'Brantner, Amber — Business',              value: '215'      },
  { label: 'Brundage, Elizabeth — History',           value: '306'      },
  { label: 'Burford, Barrett — Comm. Arts',           value: '257'      },
  { label: 'Burger, Lisa — Math',                     value: '332'      },
  { label: 'Burns, Jordan — Business',                value: '214'      },
  { label: 'Campbell, Cass — Office Manager',         value: '102'      },
  ...
  { label: 'Cochran, Blake — Science',                value: '272'      },
  ...
  { label: 'Donham, Katie — Science',                 value: '263'      },
  { label: 'Durham, Jessica — History',               value: '310'      },
  { label: 'Edwards, Alexander — History',            value: '303'      },
  { label: 'Eggleston, Beth — Journalism',            value: '221/251'  },
  ...
  { label: 'Houp, Amanda — Comm. Arts',               value: '324'      },
  { label: 'Howard, Delaney — Comm. Arts',            value: '255'      },
  ...
  { label: 'Hunt, Randi — Counselor 10th',            value: '115'      },
  { label: 'Hurlbert, Brier — Print Shop',            value: '220'      },
  { label: 'Johns, Melissa — SPED',                   value: '326'      },
  { label: 'Johnson, Madison — SPED',                 value: '222'      },
  { label: 'Jones, Tiffany — Curr. Specialist',       value: '302'      },
  { label: 'Jordan, Theodor — Science',               value: '268'      },
  { label: 'Kelly, David — Principal',                value: '100'      },
  { label: 'Kershaw, Will — Comm. Arts',              value: '256'      },
  ...
  { label: 'McMillin, Matthew — Asst. Principal 10th',value: '107'      },
  { label: 'Miller, Dustin — Asst. Principal 9th',    value: '104'      },
  { label: 'Miller, Scott — History',                 value: '311A'     },
  ...
  { label: 'Newberry, Ashley — FACS',                 value: '218/223'  },
  ...
  { label: 'Perry, John — PE',                        value: '1001'     },
  ...
  { label: 'Roller, Alayna — Asst. Principal 11th',   value: '109'      },
  { label: 'Ruffin, Heather — SPED',                  value: '208'      },
  ...
  { label: 'Wright, Jaime R. — Assoc. Principal 12th',value: '105'      },
  { label: 'Wright, Jamie — Library Aide',            value: 'Library'  },
  ...
  { label: 'Centerstone (Burrell) — Rebecca',         value: '122'      },
  { label: 'Centerstone (Burrell) — Jennifer',        value: '229'      },
  { label: 'Centerstone (Burrell) — Jenna',           value: '231'      },
  { label: 'Computer Lab B — Library',                value: '137'      },
  { label: 'Cox Clinic',                              value: '123'      },
  { label: 'Help Desk',                               value: '136'      },
  { label: 'Homebound',                               value: '176'      },
  ...
  { label: 'Wrestling Room',                          value: '2001'     },
...
// Rebuilt from the 2026-2027 Mathews routing slip. Many rooms moved that
// year -- Weaver 315 -> 308, Johnson 215 -> 315, Stech 319 -> 215, the PT/OT
// pair 203 -> 201 -- so an entry that looks wrong is probably just current.
// Former surnames are kept in the label where the slip lists them, since the
// autocomplete searches the whole label and people are still known by both.
//
// Staff the slip gives no room for are left out rather than guessed at: a
// wrong room misdelivers a drink, and the field takes free text anyway.
const MATHEWS_LOCATIONS = [
  ...
  { label: 'Brammer, Robyn — TK',                     value: '196'          },
  ...
  { label: 'Fankhauser, Peyton — Kindergarten',       value: '198'          },
  ...
  { label: 'Hurn, Janelle — Music',                   value: '317'          },
  { label: 'Johnson, Carol — Resource',               value: '315'          },
  { label: 'Keller, Leandra — Office Mgr.',           value: 'Office'       },
  { label: 'Lindsey, Emalie — Library',               value: '324'          },
  { label: 'Low, Sarah — Instructional Coach',        value: '319'          },
  { label: 'Mancusi, Vinny — Technician',             value: 'Office'       },
  { label: 'Mathie, Teal — SLP',                      value: '201'          },
  { label: 'McLain, Kelli — PT',                      value: '201'          },
  { label: 'Miesner, Sarah — Asst. Principal',        value: 'Office'       },
  { label: 'Nice (Hampton), Mary — 3rd Grade',        value: '305'          },
  { label: 'Noskowiak, Aimee — 3rd Grade',            value: '303'          },
  { label: 'Patel, Maahi — 2nd Grade',                value: '310'          },
  { label: 'Perry (Wehling), Laurin — 3rd Grade',     value: '307'          },
  { label: 'Piwko, Tami — Nurse',                     value: "Nurse's Office" },
  { label: 'Poivre, Brooke — PE',                     value: '347'          },
  { label: 'Quackenbush, Becky — Principal',          value: 'Office'       },
  { label: 'Ramsey, Brittany — OT',                   value: '201'          },
  { label: 'Reeve, DeAun — 3rd Grade',                value: '309'          },
  { label: 'Richardson, Gwyneth — Library Aide',      value: '324'          },
  { label: 'Richardson, Megan — SLP',                 value: '201'          },
  { label: 'Roach, Rachel — 2nd Grade',               value: '316'          },
  { label: 'Sackman, Melissa — 1st Grade',            value: '207'          },
  { label: 'Schatzer, Chelsea — High Needs',          value: '206'          },
  { label: 'Shears, Ashley — Kindergarten',           value: '204'          },
  ...
  { label: 'Stech, Lynsey — Resource',                value: '215'          },
  { label: 'Stricklin, Kelli — Art',                  value: '331'          },
  { label: 'Tapken, Judy — Media',                    value: '317'          },
  { label: 'Thomas, Paitlyn — 1st Grade',             value: '203'          },
  { label: 'Tyler, Jasmine — Kindergarten',           value: '200'          },
  { label: 'Weaver, Jennifer — 2nd Grade',            value: '308'          },
  // Mathews Locations
...
// COC rooms sit in another building, too far for the crew to reach on a
// delivery run, so they are off the lists above.  This also catches a COC
// typed by hand or left behind in a returning customer's saved last_room.
const BLOCKED_ROOM_MSG = 'We can’t deliver to the COC — it’s in another building. Please pick a room at the high school.';

function isBlockedDeliveryRoom(room) {
  return /\bcoc\b/i.test(String(room || ''));
}
